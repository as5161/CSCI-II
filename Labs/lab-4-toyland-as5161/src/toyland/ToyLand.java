 ...
 * @author Aamir Sohail and RIT CS
...
public class ToyLand {
    ...
    public void playTime() {
        while (!activeToys.isEmpty()) {
            ...
            IToy currentToy = activeToys.removeFirst();
            currentToy.play(time);
    ...
    public void displayStatistics() {
        ...
        for (int i =0; i < retiredToys.size(); i++){
            System.out.println("\t" + retiredToys.get(i));
            totalHappiness += retiredToys.get(i).getHappiness();
            totalWear += retiredToys.get(i).getWear();
        }
        int totalToys = retiredToys.size();
        System.out.println("Total toys: " + totalToys);
        System.out.println("Total happiness: " + totalHappiness);
        System.out.println("Average wear: " + totalWear/totalToys);
    }
